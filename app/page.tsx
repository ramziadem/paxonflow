      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            logo: 'https://paxonflow.dev/logo.svg',
            description:
              'Workflow automation for insurance agencies and small businesses. Lead capture, onboarding, CRM, and retention systems.',
            areaServed: ['United States', 'United Kingdom', 'Australia'],
            serviceType: 'Business Process Automation',
            email: 'contact@paxonflow.dev',
            priceRange: '€€',
            knowsAbout: [
              'n8n automation',
